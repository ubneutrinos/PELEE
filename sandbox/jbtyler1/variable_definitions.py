...
loosesel_variables_1eNp = [
    ("hits_ratio", 20, (0, 1), "shower hits/all hits"),                                                 #J 1eNp [0]
    ("trkfit", 20, (0, 1.0), "Fraction of Track-fitted points"),                                        #J 1eNp [1]
    ("subcluster", 20, (0, 40), "N sub-clusters in shower"),                                            #J 1eNp [2]
    ("CosmicIPAll3D", 20, (0, 200), "CosmicIPAll3D [cm]"),                                              #J 1eNp [3]
    ("shr_tkfit_dedx_max", 20, (0, 10), "shr tkfit dE/dx (max, 0-4 cm) [MeV/cm]"),                      #J 1eNp [4]
    ("tksh_angle", 20, (-1, 1), "cos(trk-shr angle)"),                                                  #J 1eNp [5] error?
    ("tksh_distance", 20, (0, 40), "trk-shr distance [cm]"),                                            #J 1eNp [6]
    ("shr_tkfit_nhits_tot", 20, (0, 20), "shr tkfit nhits (tot, 0-4 cm) [MeV/cm]"),
    ("trkpid", 21, (-1, 1), "track LLR PID"),                                                           #J 1eNp [8] error?
    ("shrmoliereavg", 20, (0, 50), "average Moliere angle [degrees]"),                                  #J 1eNp [9]
    ("shr_trk_len", 40, (0, 400), "Shower track fit length [cm]"),                                      #J 1eNp [10]
    ("nonpi0_score", 10, (0, 1.0), "BDT non-$\\pi^0$ score", "log", True),                              #J 1eNp [11]
    ("pi0_score", 10, (0, 1.0), "BDT $\\pi^0$ score", "log", True),                                     #J 1eNp [12]
...
evtsel_variabls = [
    ...
    ("CosmicDirAll3D", 20, (-1, 1), "cos(CosmicDirAll3D)"),                                             #J 1eNp [2]
    ("tk1sh1_angle_alltk", 20, (-1, 1), "cos(tk1sh1)"),                                                 #J 1e0p [3]
]
shrsel_variables = [
    ...
    ("shr_score", 20, (0, 0.5), "shr score"),                                                           #J 1eNp [2]
    ("subcluster", 20, (0, 40), "N sub-clusters in shower"),
    # ('subcluster',20,(0,80),"N sub-clusters in shower","extended"),
    ("secondshower_Y_nhit", 20, (0, 200), "Nhit 2nd shower (Y)"),                                       #J 1eNp [4]
    ("secondshower_Y_dot", 20, (-1, 1), "cos(2nd shower direction wrt vtx) (Y)"),                       #J 1eNp [5]
    ("anglediff_Y", 14, (0, 350), "angle diff 1st-2nd shower (Y) [degrees]"),                           #J 1eNp [6]
    ("secondshower_Y_vtxdist", 20, (0.0, 200), "vtx dist 2nd shower (Y)"),                              #J 1eNp [7]
    ...
    ("shr_trk_sce_start_y", 20, (-120, 120), "shr_trk_sce_start y [cm]"),                               #J 1e0p [17]
    ("shr_trk_sce_end_y", 20, (-120, 120), "shr_trk_sce_end y [cm]"),                                   #J 1e0p [18]
    ("shr_trk_len", 40, (0, 400), "Shower track fit length [cm]"),                                      #J 1e0p [19]
...
trksel_variables = [
    ...
    ("trkshrhitdist2", 20, (0, 10), "2D trk-shr distance (Y)"),                                         #J 1eNp [1]
...
bdtscore_variables = [
    ...
    # ('bkg_score',10,(0,1.0),"1e0p BDT score", "log", True),
    ("bkg_score", 10, (0, 1.0), "1e0p BDT score"),                                                  #J 1e0p [4]
    # ('bkg_score',5,(0,0.5),"1e0p BDT score","low_bdt"),
    ("bkg_score", 5, (0.5, 1.0), "1e0p BDT score", "high_bdt"),                                     #J 1e0p [5]
    # ('bkg_score',10,(0,1.0),"1e0p BDT score", "log", True),
]
energy_variables = [
...
bdt_common_variables_1eNp = [                                                                   #J 1eNp [0:10]
...
bdt_common_variables_1e0p = [                                                                   #J 1e0p [0:10]
    ("shr_score", 10, (0, 0.5), "shr score"),
...
bdt_1e0p_variables = [                                                                          #J 1e0p [0:18]
