...
PRESQ_twoplus = PRESQ + ' and n_showers_contained >= 2'
...
# SIDEBANDS CUTS
LOW_PID = '(0.0 < pi0_score < 1.0) and (0.0 < nonpi0_score < 1.0) and ~((pi0_score > 0.1) and (nonpi0_score > 0.1)) and n_showers_contained == 1'
MEDIUM_PID = '(0.1 < pi0_score < 1.0) and (0.1 < nonpi0_score < 1.0) and ~((pi0_score > 0.67) and (nonpi0_score > 0.7)) and n_showers_contained == 1'
...
stages_queries = {
    ...
    2 : ' and '.join([HIGH_ENERGY, NPVLCUTQ]),
    3 : ' and '.join([HIGH_ENERGY, NPLCUTQ]),
    4 : ' and '.join([LOW_PID, NPPRESEQ_one_shower]),
    5 : ' and '.join([HIGH_ENERGY, BDTCQ]),
}
...
#         ('n_tracks_contained',5,(0.5, 5.5),"n tracks contained"),
...
#         ('tksh_distance',20,(0,10),"tksh distance [cm]"),
...
#         ('pi0_score',10,(0,1.0),"BDT $\pi^0$ score"),
        ('pi0_score',1,(0.5, 1),"BDT $\pi^0$ score"),
